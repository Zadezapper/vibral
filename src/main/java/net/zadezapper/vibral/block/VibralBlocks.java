...
public class VibralBlocks {
    public static final Block VIBRAL_BLOCK = register( "vibral_block",
        new Block(AbstractBlock.Settings.create()
            .strength(5f)
            .requiresTool()
            .sounds(BlockSoundGroup.METAL))
    );
    public static final Block RAW_VIBRAL_BLOCK = register( "raw_vibral_block",
        new Block(AbstractBlock.Settings.create()
            .strength(0.6f)
            .requiresTool()
            .sounds(BlockSoundGroup.METAL))
    );
    public static final Block RAW_VIBRAL = register( "raw_vibral",
    ...
    public static final Block VIBRAL_PANEL = register( "vibral_panel",
        new VibralPanelBlock(AbstractBlock.Settings.create()
            .strength(1f)
            .requiresTool()
            .sounds(BlockSoundGroup.METAL))
    );
    public static final Block ECHO = register( "echo",
